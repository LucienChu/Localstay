    ...
    <div class="layout-wrapper layout-2">
        ...
        <div class="layout-container">
            ...
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <span class="text-muted font-weight-light">Forms /</span> Landlord Sign Up
                </h4>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="validation-email" placeholder="First Name">
                        <small class="form-text text-muted">Ex: John</small>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Last Name</label>
                        <input type="text" class="form-control" name="validation-email" placeholder="Last Name">
