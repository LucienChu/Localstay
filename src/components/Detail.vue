<template>
    <b-container>
        <b-form-group label="Property Size">
            <b-form-radio-group id="propertySize"
            buttons
        ...
        <b-form-group label="Available from">
            <datepicker v-model="form.availability.date1" :bootstrapStyling="true" v-on:selected="chooseDate"/>
        </b-form-group>
        <b-form-group label="To">
            <datepicker v-model="form.availability.date2" :bootstrapStyling="true" v-on:selected="chooseDate"/>
        </b-form-group>
        <b-form-group label="Airbnb (or similar sites) link- Optional">
            <b-form-input id="airbnb"
            type="text"
