    ...
    <div class="container swiper-text-container d-flex flex-column flex-warp">
      ...
      <div class="row order-md-3 order-sm-2 order-2">
        <div class="col-md-3 col-6 ml-auto text-right">
          <a href="#">
            <h4 style="margin-bottom: 0px;">In partnership with Marriott International</h4>
          </a>
        </div>
        <div class="col-md-3 col-6 mr-auto my-auto" style="border-left: 1px solid white">
          <a href="#">
            <img src="img/partners/marriott_international_logo.svg" alt>
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid swiper-container">
      <div class="row">
        <swiper :options="swiperWithPagination" autoplay="true">
          <swiper-slide>
            <img class="swiper-image" src="/img/bg/1.jpg" alt="swiper images">
          </swiper-slide>
          <swiper-slide>
            <img class="swiper-image" src="/img/bg/2.jpg" alt="swiper images">
          </swiper-slide>
          <swiper-slide>
            <img class="swiper-image" src="/img/bg/3.jpg" alt="swiper images">
          </swiper-slide>
