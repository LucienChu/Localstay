<template >
  <b-container fluid class="container-wrapper">
    <b-container class="text-center mt-5">
      <b-col lg="3" md="4" cols="2" class="mx-auto pb-3" id="company-logo">
        <a href="/">
          <img src="/img/logo/localstay-logo.png" alt="localstay logo image" style="width: 100%">
        </a>
      </b-col>
      <b-col md="3" cols="4" class="mx-auto pb-3" id="company-logo-small">
        <a href="/">
          <img
            src="/img/logo/localstay-logo-small.png"
            alt="localstay logo image"
            style="width: 50%"
          >
        </a>
      </b-col>
      <b-col lg="6" md="8" cols="12" class="mx-auto" id="get-start-statement">
        <h3 class="display-4">Supercharge your rental income by 30%</h3>
      </b-col>
    </b-container>
...
/* get start statement */
#get-start-statement .display-4 {
  font-size: 1.3em;
  color: #ffffff;
  font-weight: 400;
}
/* end get start statement */
#get-start-form-card {
  display: flex;
